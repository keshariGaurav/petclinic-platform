---
name: deploy-dev
description: Deploy one or all Petclinic services to the dev EKS namespace via ArgoCD, using kubectl only for bootstrap. Requires an explicit deployment request before mutation.
---
