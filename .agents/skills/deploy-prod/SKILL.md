---
name: deploy-prod
description: Deploy one or all Petclinic services to production via manual ArgoCD sync with safety checks. Requires an explicit production deployment request before mutation.
---
