...
description: Review Petclinic Terraform for security, AWS best practices, cost, and repository conventions without changing infrastructure.
---
...
2. Check against the project's Terraform conventions in `AGENTS.md` and `.codex/guides/rules/terraform.md`:
